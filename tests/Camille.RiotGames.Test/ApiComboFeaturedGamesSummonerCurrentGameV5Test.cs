...
{
    [TestClass]
    public class ApiComboFeaturedGamesSummonerCurrentGameV5Test : ApiTest
    {
        ...
        public void Get()
        {
            var featured = Api.SpectatorV5().GetFeaturedGames(REGION);
        ...
        {
            var featured = await Api.SpectatorV5().GetFeaturedGamesAsync(REGION);
            CheckFeatured(featured);
